        ...
        <>
            <div
                ...
                <div className=" container mx-auto flex justify-center items-center h-96">
                    <div className=" ">
                        <h1 className=' text-white text-center lg:text-5xl md:text-5xl text-3xl px-5  font-bold lg:px-20 mb-5'>The biggest PAK hits. The best PAK and india stories. All streaming here.
                        </h1>
